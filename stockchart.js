document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', function() {
      if (isElementInViewports(pieChartSection) && !hasAnimatedPie) {
        initStockPieChart(); // 初始化圓餅圖
